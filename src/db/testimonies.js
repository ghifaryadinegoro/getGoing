const testimonies = [
  ...
  },
  {
    ...
    occupation: "Banker",
    image:
      "https://ik.imagekit.io/getgoing/tr:w-500,h-500/v0/b/getgoing-prod.appspot.com/o/CMS%2F1711351458D489AF07-D4B4-47D7-A6C1-966BE41F01F7%20(1)-min.jpg?alt=media&token=8ba3ff45-2dff-4e6d-8af4-073b7623813a",
    title: "Liburan keluarga yang sangat berkesan dan menyenangkan",
    text: `Sekali lagi, terima kasih semua yg tak terhingga pada
All Team GetGoing yang SUPER DUPER KEREN! yang udah gercep pandu kita, gercep belikan tiket reshecedhule kemarin, kasih ide2 get lost yang mantap, kasih hotel yang nyaman dll semua nya yg ga bisa saya sebutkan satu per satu... Alhamdulillah ini liburan keluarga yg sgt berkesan dan menyenangkan, dan bucket list impian ke swiss bisa terwujud... Alhamdulillaaah 🤲🏻🤲🏻 THE BEST BUAT GETGOING TEAM
KALIAAAN TERBAIIIIKKKK.`,
  },
  {
    id: 4,
    name: "Meta",
    occupation: "Writer",
    image:
      "https://ik.imagekit.io/getgoing/tr:w-500,h-500/v0/b/getgoing-prod.appspot.com/o/CMS%2F171135069520230622_174403-min.jpg?alt=media&token=fc0fa5c4-9b99-4344-b91d-b9211429edd7",
  ...
  },
  {
    ...
    occupation: "Entreprenur & Banker",
    image:
      "https://ik.imagekit.io/getgoing/tr:w-500,h-500/v0/b/getgoing-prod.appspot.com/o/CMS%2F1711350701IMG_2064-min.jpg?alt=media&token=b0036122-135b-40da-84aa-a7f9530b2499",
